...
L:RegisterTranslations("zhCN", function() return {
    ...
    ["Add Nickname"] = "添加昵称",
    ["Adds an alternate name to show in popups."] = "在弹出窗口中加入一个昵称",
    ["Remove Nickname"] = "移除昵称",
	["Removes an alternate name to show in popups."] = "移除弹出窗口的一个昵称",
    ["Clear Nickname"] = "清除昵称",
	["Clears alternate name to show in popups."] = "清除所有的弹出窗口昵称",
    ["framealpha_name"] = "弹出窗口透明度",
    ["framealpha_desc"] = "设置弹出信息窗口的透明度",
	["Popup"] = "弹出窗口",
    ["Shows messages in a popup window."] = "在弹出窗口中显示信息",
...
Prat_PopupMessage.revision = tonumber(string.sub("$Revision: 63496 $", 12, -3))
