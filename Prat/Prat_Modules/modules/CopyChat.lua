...
L:RegisterTranslations("zhCN", function() return {
	...
	["Should the copied text be plain, or formatted so you can see the colors."] = "设置是仅复制文本，还是连格式一起复制(可以保持颜色)。",
	["Plain"] = "文本",
	["HTML"] = "网页",
	["BBCode"] = "BBCode"
} end)
...
Prat_CopyChat.revision = tonumber(string.sub("$Revision: 63496 $", 12, -3))
