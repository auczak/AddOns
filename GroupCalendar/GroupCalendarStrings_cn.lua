...
-- Tradeskill cooldown items
	...
	GroupCalendar_cTransmutePrimalAirToFire = "转换: Primal Air to Fire"
	GroupCalendar_cTransmutePrimalFireToEarth = "转换: Primal Fire to Earth"
	GroupCalendar_cTransmutePrimalEarthToWater = "转换: Primal Earth to Water"
	GroupCalendar_cTransmutePrimalWaterToAir = "转换: Primal Water to Air"
	GroupCalendar_cTransmutePrimalEarthToLife = "转换: Primal Earth to Life"
	GroupCalendar_cTransmutePrimalLifeToEarth= "转换: Primal Life To Earth"
	GroupCalendar_cTransmutePrimalFireToMana = "转换: Primal Fire to Mana"
	GroupCalendar_cTransmutePrimalManaToFire = "转换: Primal Mana to Fire"
	GroupCalendar_cTransmutePrimalShadowToWater = "转换: Primal Shadow to Water"
	GroupCalendar_cTransmutePrimalWaterToShadow = "转换: Primal Water to Shadow"
	GroupCalendar_cTransmutePrimalMight = "转换: Primal Might"
	GroupCalendar_cTransmuteEarthstormDiamond = "转换: Earthstorm Diamond"
	GroupCalendar_cTransmuteSkyfireDiamond = "转换: Skyfire Diamond"
