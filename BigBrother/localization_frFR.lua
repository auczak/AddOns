...
L:RegisterTranslations("frFR", function() return {
	...
	["Reports if and which player breaks crowd control effects (like polymorph, shackle undead, etc.) on enemies."] = "Indique si les métamorphoses et les entraves ont été enlevées et par qui.",
...
--	["CC on %s removed too frequently.  Throttling announcements."] = "",
	...
	-- EPGP support
	["Everyone has a flask or an elixir, good job!"] = "Everyone has a flask or an elixir, good job!",
	["WARNING - use flask or elixir - otherwise penalty of %d will be applied to following players: %s"] = "WARNING - use flask or elixir - otherwise penalty of %d will be applied to following players: %s",
	["Penalty for missing flask or elixir:"] = "Penalty for missing flask or elixir:",
	["Everyone has food buff, good job!"] = "Everyone has food buff, good job!",
	["WARNING - use food buff - otherwise penalty of %d will be applied to following players: %s"] = "WARNING - use food buff - otherwise penalty of %d will be applied to following players: %s",
	["Penalty for missing food buff:"] = "Penalty for missing food buff:",
} end)
