...
L:RegisterTranslations("enUS", function() return {
	...
	-- EPGP support
	["Everyone has a flask or an elixir, good job!"] = true,
	["WARNING - use flask or elixir - otherwise penalty of %d will be applied to following players: %s"] = true,
	["Penalty for missing flask or elixir:"] = true,
	["Everyone has food buff, good job!"] = true,
	["WARNING - use food buff - otherwise penalty of %d will be applied to following players: %s"] = true,
	["Penalty for missing food buff:"] = true,
