	...
	for i,entry in pairs(channelList) do
		if (entry.channel == outputChannel) then
			if (outputChannel ~= "CHANNEL" or entry.index == outputChannelIndex) then
				...
				outputChannelColour = {entry.colour.r, entry.colour.g, entry.colour.b}
			end
		end
